        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArchivedMonth = table.Column<int>(type: "INTEGER", nullable: false),
                    ArchivedYear = table.Column<int>(type: "INTEGER", nullable: false),
                    Type = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArchivedExpenses", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CorporateProfileId = table.Column<int>(type: "INTEGER", nullable: true),
                    ...
                    CorporateProfileEntityId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Users", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Users_CorporateProfiles_CorporateProfileEntityId",
                        column: x => x.CorporateProfileEntityId,
                        principalTable: "CorporateProfiles",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_CorporateProfileEntityId",
                table: "Users",
                column: "CorporateProfileEntityId");
